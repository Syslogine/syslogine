          ...
          items: [
            {
              ...
              link: { type: 'doc', id: 'linux/alpine/software/package-management/install-packages/index' },
              items: []
            },
            {
              type: 'category',
              label: 'Remove Packages',
              link: { type: 'doc', id: 'linux/alpine/software/package-management/remove-packages/index' },
              items: []
            },
            {
              type: 'category',
            ...
            },
{
    ...
    },
    {
      ...
      ], // voeg later subcategorieën of docs toe
    },
    {
      type: 'category',
      label: 'Arch',
