// src/components/MultiVariantContent.jsx
...
const MultiVariantContent = ({ 
  ...
  // Auto-select first available option when parent changes
  useEffect(() => {
  ...
  // Load file content if in file mode
  useEffect(() => {
    if (mode === "file") {
  ...
  }, [selection, variants, mode]);

  // Get current content (for inline mode)
  const getCurrentContent = () => {
    return variants[selection.os]?.[selection.version]?.[selection.environment]?.[selection.level];
  };
        ...
        {mode === "file" ? (
          ...
          getCurrentContent() || (
            <div className="no-content">
              No content available for this combination.
            </div>
          )
        )}
      </div>
...
export default MultiVariantContent;